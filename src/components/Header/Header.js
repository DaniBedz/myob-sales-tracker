...
function Header() {
  return (
    <div style={ containerStyle }>
      <div className="row">
        <div className="col-8">
          <svg id="myob-logo" style={ logoStyle } preserveAspectRatio="xMidYMin slice" data-name="img_mega-nav_myob-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 116.4" aria-label="MYOB logo">
            <defs>
                <linearGradient id="logo-gradient" gradientUnits="userSpaceOnUse" x1="0" y1="58.2083" x2="283.4646" y2="58.2083">
                    <stop offset="0.36" stopColor="#6100A5"></stop>
                    <stop offset="0.4557" stopColor="#7001A0"></stop>
                    <stop offset="0.6409" stopColor="#980293"></stop>
                    <stop offset="0.8947" stopColor="#D9057E"></stop>
                    <stop offset="0.97" stopColor="#ED0677"></stop>
                </linearGradient>
            </defs>
        ...
        <span id='title' style={ titleStyle }>Sale Tracker</span>
        </div>
